...
import { TailSpin } from 'react-loader-spinner'; // Ensure this is installed with npm install react-loader-spinner
    ...
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 h-screen p-3 flex flex-col justify-center items-center">
      ...
      >
        <a href="https://github.com/Vishesh-Pandey/chat-ai" target="_blank" rel="noopener noreferrer">
          <h1 className="text-4xl font-bold text-blue-500 mb-4 animate-bounce">SheSquad-AI</h1>
        </a>
        <textarea
          required
      ...
      {/* Loading Spinner */}
      {generatingAnswer && <TailSpin height="50" width="50" color="#388697" ariaLabel="loading" />}

      {/* Answer Box */}
      <div className="w-full md:w-2/3 lg:w-1/2 xl:w-1/3 text-center rounded-lg bg-white my-4 shadow-lg transition-all duration-500 transform hover:scale-105 fade-in">
        <div className="answer-box">
          <ReactMarkdown className="p-4 markdown-content">
            {answer}
          </ReactMarkdown>
        </div>
      </div>
